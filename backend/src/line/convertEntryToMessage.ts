...
export const convertEntryToChangeMessage = (entry: EntryDto): FlexMessage => {
  const {
    visitDay,
    visitTime,
    familyName,
        ...
        contents: [
                ...
                contents: [
                  ...
                  },
                  {
                    ...
                    contents: [
                      ...
                      {
                        type: 'text',
                        text: '・XXXXXXXXXXXXについては要予約となります。現在全ての日時において満席となっています。ご了承ください。',
                        wrap: true,
                        color: '#000000',
                        size: 'md',
                        flex: 5,
          ...
          },
          {
            ...
            action: {
              type: 'uri',
              label: '予約内容の確認・変更',
              uri: 'https://liff.line.me/<%= liff_main_id %>/reference',
            },
          },
          {
            type: 'box',
            ...
            action: {
              type: 'uri',
              uri: 'https://liff.line.me/<%= liff_main_id %>/cancel',
              label: '予約をキャンセル',
            },
          },
          {
...
export const convertEntryToMessage = (entry: EntryDto): FlexMessage => {
  const {
    visitDay,
    visitTime,
    familyName,
        ...
        contents: [
          ...
          },
          {
            ...
            action: {
              type: 'uri',
              label: '予約内容の確認・変更',
              uri: 'https://97008e4c337b.ngrok.app/confirm',
            },
          },
          {
            type: 'box',
            ...
            action: {
              type: 'uri',
              uri: 'https://97008e4c337b.ngrok.app/cancel/confirm',
              label: '予約をキャンセル',
            },
          },
          {
          ...
          },
          {
            ...
            action: {
              type: 'uri',
              label: 'チェックイン',
              uri: 'https://97008e4c337b.ngrok.app/checkin',
            },
          },
        ],
      },
